...
#SBATCH --job-name=STAR_align_all_try4.sh_20231113
...
# 'STAR_align/bam' at location '/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/STAR_CabV3'
...
indexed_ref_genome_dir=/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/STAR_CabV3/STAR_index  # input directory of the indexed reference genome from the last step ('STAR_index_try2.sh')
ref_gtf=/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CabSav_annoV3.gtf       # genome annotation file
output_dir=/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/STAR_CabV3/STAR_align/bam         # output directory which will contain a finalized, sorted .bam .bam file
