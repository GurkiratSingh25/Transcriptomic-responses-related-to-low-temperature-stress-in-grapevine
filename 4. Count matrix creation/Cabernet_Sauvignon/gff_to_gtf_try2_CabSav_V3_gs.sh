...
agat_convert_sp_gff2gtf.pl \
	--gff /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/Cab08.chr.gff3 \
	--out /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.AGAT_try3.10.gtf
...
head -n 50 \
/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.AGAT_try3.10.gtf \
> /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.AGAT_try3.10.gtf.50lines
...
awk -F '\t' '$3=="gene"' /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/Cab08.chr.gff3 | wc -l
# Result = 36,689


# Query the .gtf file for how many times the word 'gene' occurs in its 3rd column - the feature column
awk -F '\t' '$3=="gene"' /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.AGAT_try3.10.gtf | wc -l
# Result = 36,689
...
cp \
/fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.AGAT_try3.10.gtf \
> /fs/ess/PAS1444/Freezing_tolerance_RNA_Seq/work_dir/CoCo_CabSav_V3/Cab_Sav_annoV3.plusgenes.gtf




##If the above renaming code works, its okay, else
##go change directory to CoCo and command > cp Cab_Sav_annoV3.AGAT_try3.10.gtf Cab_Sav_annoV3.plusgenes.gtf
